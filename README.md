...
Place all GUI-related source files in this folder. The graphical version is started by calling `startRaceGUI()`.

### How to compile

```bash
cd Part2
javac Typist.java TypingRace.java TypingRaceGUI.java
```
